...
## Changes
Added compatibility with Fingerbot 6jcvqwh0
...
* Fingerbots (category_id 'szjqr')
  ...
  + Fingerbot Plus (product_ids 'blliqpsj', 'ndvkgsrm', 'yiihr7zh', 'neq16kgd', '6jcvqwh0'), almost same as original, has sensor button for manual control.
